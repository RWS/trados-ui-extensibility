...
const envConfig = {
  ...
  ENVIRONMENTS: {
    LOCAL: {
      apiUrl: "https://ci-lc-api.sdl.com/public-api/v1"
    },
    CI: {
      apiUrl: "https://ci-lc-api.sdl.com/public-api/v1"
    },
    QA: {
      apiUrl: "https://qa-lc-api.sdl.com/public-api/v1"
    },
    PTE: {
      apiUrl: "https://pte-lc-api.sdl.com/public-api/v1"
    },
    UAT: {
      apiUrl: "https://uat-lc-api.sdl.com/public-api/v1"
    },
    STG: {
      apiUrl: "https://staging-lc-api.sdl.com/public-api/v1"
    },
    PROD: {
      apiUrl: "https://lc-api.sdl.com/public-api/v1"
    }
  }
};
