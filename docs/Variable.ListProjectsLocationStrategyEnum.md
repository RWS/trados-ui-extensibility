[Trados User Interface Extensibility v1.0.0](../wiki/globals) / ListProjectsLocationStrategyEnum

# Variable: ListProjectsLocationStrategyEnum

> `const` **ListProjectsLocationStrategyEnum**: `object`
